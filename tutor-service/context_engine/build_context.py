"""right here , we are turning raw request payload into structured StudentContext the tutor Agent can use 
 who the student is , what course/lesson they're in and whether this is graded work"""
...
class StudentContext:
    """everything the tutor needs to know who it's talking to ,
    ...
    def as_prompt_block(self) -> str:
        """the cheap , always relevant chunk that gets pushed straight into the 
        system prompt"""
        history_lines = "\n".join(
        ...
        return (
            ...
            f"Recent quiz perfomance:\n{history_lines}"
        )


    def build_student_context(raw:dict[str , Any]) -> StudentContext:
        """here turns raw request payload (from the gateway or the mock into structured Student context)"""
